...
public class Prjava43garcia20 extends Frame
   ...
   public Prjava43garcia20 () {
      ...
      setTitle("nova finestra prjava43garcia20");  // "this" Frame sets title
   ...
   public static void main(String[] args) {
      new Prjava43garcia20();  // Let the construct do the job
   }
